...
void jsonGPRSState(cJSON *pItem)
{
    ...
    cJSON_AddStringToObject(pItem, "alphan", g_xGPRS_COPS.nCount > 0 ? g_xGPRS_COPS.xCOPS[0].alphan : "");
...

    {
            ...
            cJSON_AddNumberToObject(pItem, "n_type", vCheckCellNetType()); //网口类型GPRS/LTE/NBIOT,目前暂不支持NB-IOT
    }
