...
static void prvSetUartCfgsDefault(void)
{
    ...
    g_uart_cfgs[2].uart_type = gUartType.eUart2Type;
    g_uart_cfgs[3].uart_type = gUartType.eUart3Type;
    g_uart_cfgs[4].uart_type = UART_TYPE_ZIGBEE;
    g_uart_cfgs[5].uart_type = UART_TYPE_GPRS;
}
...
rt_err_t uart_cfg_init(void)
{
    ...
    g_uart_cfgs[4] = c_uart_default_cfgs[4];
