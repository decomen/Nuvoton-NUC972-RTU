...
#define PRODUCT_MODEL       DM_C503H14GZ_PRODUCT_NAME
...
#define BOARD_UART_2_TYPE           UART_TYPE_232
#define BOARD_UART_3_TYPE           UART_TYPE_232
#define BOARD_UART_4_TYPE           UART_TYPE_ZIGBEE
#define BOARD_UART_5_TYPE           UART_TYPE_GPRS

#define BOARD_ZIGBEE_UART           4
#define BOARD_LORA_UART             4
#define BOARD_GPRS_UART             5
...
typedef struct {
    ...
    uart_type_e eUart2Type;
    uart_type_e eUart3Type;
} s_Rs232_Rs485_Stat;
